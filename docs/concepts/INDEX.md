...
| [03-secure-boot.md](03-secure-boot.md) | Secure Boot: U-Boot Verified Boot (FIT image + RSA2048) + signed `.swu` (CMS/X.509), cơ chế bật/tắt theo DISTRO_FEATURES, giới hạn hiện tại |
